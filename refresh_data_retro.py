...
DATA_SOURCES = {
    "TYPES": {
        "destination": "__InputRetroCreateTypeLookup.gml",
        "sources": {
...
GAMEPAD_TYPE_MAPPING = {
    "INPUT_GAMEPAD_TYPE_NEOGEO": ["CommunityNeoGeo"],
    "INPUT_GAMEPAD_TYPE_SATURN": ["CommunitySaturn", "CommunityAstroCity"],
    "INPUT_GAMEPAD_TYPE_N64": ["CommunityN64"],
    "INPUT_GAMEPAD_TYPE_GAMECUBE": ["CommunityGameCube"],
}
...
for file in DATA_SOURCES:
    ...
    working_path = os.path.join(script_dir, "scripts/__InputRetroCreateTypeLookup", filename)
